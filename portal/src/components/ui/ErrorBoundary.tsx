    ...
    public render() {
        if (this.state.hasError) {
            return this.props.fallback || (
                <div className="p-6 text-center space-y-4 bg-white rounded-lg shadow-sm border border-slate-200 m-4">
                    <h2 className="text-xl font-bold text-slate-900">Oups ! Une erreur est survenue</h2>
